...
const GROUND_ATLAS: Record<string, string> = {
  ...
  'Reykjavík':         '/ground/ground_atlas_reykjavik.png',
...
export const ENVIRONMENTS: EnvironmentPreset[] = [
  ...
  // ── Piran — Medieval Venetian coastal gem, terracotta roofs, warm Adriatic twilight ──
  {
    name: 'Piran',
    fogColor: 0x8a7a6a, fogDensity: 0.00015,
    skyTop: 0x0a1530, skyBottom: 0x4488bb, skyHorizon: 0xffaa66,
    skyMid: 0x2266aa, horizonGlow: 0xffcc88,
    hemiSky: 0xccddee, hemiGround: 0x6a5a4a, hemiIntensity: 1.0,
    dirColor: 0xffcc88, dirIntensity: 1.8, dirPosition: [-55, 25, 50],
    groundColor: 0x3a3020, exposure: 1.1,
    scenery: {
      roadColor: 0x4a4038, roadRoughness: 0.7,
      barrierColor: 0x8a7a6a,
      buildingPalette: [0xcc9955, 0xbb7766, 0xddbb88, 0xaa8866, 0xccaa77, 0x998866],
      buildingHeightRange: [3, 8],
      windowLitChance: 0.6, windowColor: 0xffdd88,
      treeTrunkColor: 0x443322, treeCanopyColor: 0x3a5a2a,
      treeCanopyStyle: 'sphere', treeCount: 8,
      billboardStyle: 'none',
      streetLightColor: 0xffcc66, streetLightDensity: 0.5,
      groundTexture: 'concrete',
      kerbColor: 0x7a6a5a, shoulderColor: 0x5a4a3a,
      mountainColor: 0x5a6a5a, mountainHeight: 1.2, cloudOpacity: 0.2, cloudTint: 0xffaa77,
      fenceDensity: 0.3, rockDensity: 0.6, rockColor: 0x8a7a6a, bushDensity: 0.3,
      spectatorDensity: 0.5,
      accentProps: ['debris'],
      roadDecals: ['puddle', 'lane_paint'],
      atmosphericEffects: ['fog_wisps'],
      buildingStyle: 'piran',
      buildingModels: [],
      buildingDensity: 2.0, buildingRowCount: 2, buildingGapChance: 0.08,
      treeVariant: 'standard',
      treeModels: ['pine.glb'],
      ambientLights: ['window_spill'],
      barrierStyle: 'concrete_weathered',
    },
  },

  // ── Tel Megiddo — Ancient archaeological tel, Jezreel Valley, Bronze Age ruins ──
  {
    name: 'Tel Megiddo',
    fogColor: 0x8a7a55, fogDensity: 0.00020,
    skyTop: 0x1a1428, skyBottom: 0xcc9944, skyHorizon: 0xeebb55,
    skyMid: 0x775522, horizonGlow: 0xffcc55,
    hemiSky: 0xddcc88, hemiGround: 0x776633, hemiIntensity: 1.1,
    dirColor: 0xffcc77, dirIntensity: 2.0, dirPosition: [-45, 45, 50],
    groundColor: 0x3a3020, exposure: 1.15,
    scenery: {
      roadColor: 0x4a4030, roadRoughness: 0.8,
      barrierColor: 0x8a7a55,
      buildingPalette: [0x9a8a60, 0xaa9a70, 0x807050, 0xbbaa80],
      buildingHeightRange: [2, 6],
      windowLitChance: 0.15, windowColor: 0xffcc55,
      treeTrunkColor: 0x554433, treeCanopyColor: 0x5a7a3a,
      treeCanopyStyle: 'sphere', treeCount: 10,
      billboardStyle: 'none',
      streetLightColor: 0xffcc55, streetLightDensity: 0.2,
      groundTexture: 'sand',
      kerbColor: 0xaa9977, shoulderColor: 0x776644,
      mountainColor: 0x7a7a50, mountainHeight: 1.5,
      cloudOpacity: 0.1, cloudTint: 0xddbb55,
      fenceDensity: 0.2, rockDensity: 1.5,
      rockColor: 0x9a8a60, bushDensity: 0.4,
      spectatorDensity: 0.3,
      accentProps: ['debris', 'cactus'],
      roadDecals: ['crack', 'sand_drift'],
      atmosphericEffects: ['dust'],
      buildingStyle: 'tel_megiddo',
      buildingModels: [],
      buildingDensity: 0.6, buildingRowCount: 1, buildingGapChance: 0.35,
      treeVariant: 'standard',
      treeModels: ['pine.glb', 'pine_b.glb', 'cactus.glb', 'cactus_b.glb'],
      ambientLights: ['window_spill'],
      barrierStyle: 'concrete_weathered',
    },
  },
