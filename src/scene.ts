...
export const ENVIRONMENTS: EnvironmentPreset[] = [
  {
    ...
    scenery: {
      ...
      buildingModels: ['skyscraper.glb', 'nyc_skyscraper.glb', 'nyc_skyscraper_b.glb', 'nyc_apartment.glb', 'nyc_apartment_b.glb', 'nyc_apartment_c.glb', 'nyc_apartment_d.glb', 'office_b.glb'],
  ...
  },
  {
    ...
    scenery: {
      ...
      buildingModels: ['skyscraper.glb', 'coastal_home.glb'],
  ...
  },
  {
    ...
    scenery: {
      ...
      treeCanopyStyle: 'cone', treeCount: 45,
      billboardStyle: 'minimal',
      ...
      spectatorDensity: 0.8, accentProps: ['palm_trunk', 'traffic_cone'],
      atmosphericEffects: ['fireflies', 'leaves'], buildingStyle: 'beach_house', treeVariant: 'layered_pine',
      buildingModels: ['coastal_a.glb', 'coastal_b.glb', 'coastal_home.glb'],
      treeModels: ['pine.glb', 'pine_b.glb', 'dogwood.glb', 'oak.glb', 'palm_tree.glb'],
      ambientLights: ['window_spill'],
    },
  },
  {
    ...
    scenery: {
      ...
      spectatorDensity: 0.5, accentProps: ['neon_strip', 'traffic_cone'],
      roadDecals: ['lane_paint', 'manhole'], buildingStyle: 'cyberpunk',
      buildingModels: ['skyscraper.glb', 'nyc_skyscraper.glb', 'nyc_skyscraper_b.glb', 'office.glb', 'nyc_apartment_b.glb'],
  ...
  },
  {
    ...
    scenery: {
      ...
      spectatorDensity: 0.3, accentProps: ['debris', 'traffic_cone'],
      roadDecals: ['puddle', 'crack'], atmosphericEffects: ['leaves', 'fog_wisps'], buildingStyle: 'weathered',
      buildingModels: ['nyc_apartment.glb', 'nyc_apartment_b.glb', 'nyc_apartment_c.glb', 'nyc_apartment_d.glb', 'skyscraper.glb', 'nyc_skyscraper_b.glb', 'office.glb', 'office_b.glb'],
      treeModels: ['red_maple.glb', 'red_maple_b.glb', 'pine.glb', 'black_walnut.glb', 'black_walnut_b.glb', 'walnut.glb'],
  ...
  },
  {
    ...
    scenery: {
      ...
      spectatorDensity: 0.8, accentProps: ['snow_bollard', 'debris'],
  ...
  },
  {
    ...
    scenery: {
      ...
      fenceDensity: 0.3, rockDensity: 0.8, rockColor: 0x8899aa, bushDensity: 0.5,
      spectatorDensity: 0.2, accentProps: ['snow_bollard', 'debris'],
  ...
  },
  {
    ...
    scenery: {
      ...
      fenceDensity: 0.8, rockDensity: 0.5, rockColor: 0x1a2535, bushDensity: 0.3,
      spectatorDensity: 0.5, accentProps: ['snow_bollard', 'traffic_cone'],
      roadDecals: ['frost'], buildingStyle: 'concrete',
      buildingModels: ['skyscraper.glb', 'nyc_skyscraper.glb', 'nyc_skyscraper_b.glb', 'office.glb', 'office_b.glb', 'nyc_apartment_c.glb', 'nyc_apartment_d.glb'],
    },
  },
  // ── 4 New Environments ──
  {
    ...
    scenery: {
      ...
      treeCanopyStyle: 'cone', treeCount: 60,
      billboardStyle: 'minimal',
      ...
      spectatorDensity: 0.5, accentProps: ['tiki_torch', 'palm_trunk'],
      roadDecals: ['puddle'], atmosphericEffects: ['fireflies', 'fog_wisps'], buildingStyle: 'bamboo_lodge', treeVariant: 'palm_frond',
      buildingModels: ['coastal_a.glb', 'coastal_b.glb', 'coastal_home.glb'],
      treeModels: ['dogwood.glb', 'red_maple.glb', 'walnut.glb', 'palm_tree.glb', 'palm_tree_b.glb', 'palm_tree_c.glb', 'palm_trees_cluster.glb'],
  ...
  },
  {
    ...
    scenery: {
      ...
      fenceDensity: 1.5, rockDensity: 0.5, rockColor: 0x555045, bushDensity: 0.4,
      spectatorDensity: 0.3, accentProps: ['smokestack', 'traffic_cone', 'dumpster'],
      roadDecals: ['crack', 'manhole'], atmosphericEffects: ['steam', 'embers'], buildingStyle: 'warehouse',
      buildingModels: ['office.glb', 'office_b.glb', 'nyc_apartment.glb', 'nyc_apartment_c.glb', 'nyc_apartment_d.glb', 'nyc_skyscraper_b.glb'],
      treeModels: ['red_maple.glb', 'black_walnut.glb'],
      ambientLights: ['torch_glow'],
    },
  },
  {
    ...
    scenery: {
      ...
      treeCanopyStyle: 'sphere', treeCount: 55,
      billboardStyle: 'minimal',
      ...
      spectatorDensity: 0.5, accentProps: ['wind_turbine', 'traffic_cone'],
      roadDecals: ['lane_paint'], atmosphericEffects: ['dust'], buildingStyle: 'beach_house',
      buildingModels: ['coastal_a.glb', 'coastal_b.glb', 'coastal_home.glb'],
      treeModels: ['pine.glb', 'pine_b.glb', 'dogwood.glb', 'red_maple.glb', 'red_maple_b.glb', 'walnut.glb', 'walnut_b.glb', 'oak.glb'],
    },
  },
  {
    name: 'Underground',
    ...
    scenery: {
      ...
      spectatorDensity: 0.0, accentProps: ['ceiling_panel', 'neon_strip'],
