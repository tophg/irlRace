...
export const ENV_FLAVOR: Record<string, string> = {
  ...
  'Chennai': 'South Indian metropolis, monsoon heat and temple spires',
  'Sukhumi': 'Overgrown Black Sea ruins, haunted resort town',
  'Shanghai': 'Art Deco Bund meets Pudong neon skyline',
  'Sochi': 'Subtropical Black Sea coast, Soviet resort grandeur',
