...
export const CAR_ROSTER: CarDef[] = [
  ...
  { id: 'further',       name: 'Further',       file: 'VW_Beetle_Souped.glb', maxSpeed: 68, acceleration: 26, handling: 2.7, braking: 40, driftFactor: 0.35, gripCoeff: 0.82, latFriction: 4.8, suspStiffness: 0.06, steerSpeed: 3.0,  driftThreshold: 0.10, mass: 1200, cgHeight: 0.14, frontBias: 0.42, heightOffset: 0.05 },
  ...
  { id: 'phantom',       name: 'Phantom',       file: 'phantom.glb',           maxSpeed: 91, acceleration: 38, handling: 3.1, braking: 55, driftFactor: 0.42, gripCoeff: 0.86, latFriction: 5.2, suspStiffness: 0.04, steerSpeed: 3.4,  driftThreshold: 0.09, mass: 1300, cgHeight: 0.08, frontBias: 0.43, heightOffset: 0.0 },
  // Punisher — brutal muscle machine, aggressive, heavy but explosive acceleration
  { id: 'punisher',      name: 'Punisher',      file: 'Punisher.glb',          maxSpeed: 88, acceleration: 35, handling: 2.1, braking: 53, driftFactor: 0.38, gripCoeff: 0.88, latFriction: 5.4, suspStiffness: 0.05, steerSpeed: 2.9,  driftThreshold: 0.10, mass: 1850, cgHeight: 0.14, frontBias: 0.50, heightOffset: 0.10 },
