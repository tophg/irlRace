...
| `scripts/gen-havana-facade-tiles.mjs` | Batch Havana facade tile generator with ref feedback | `GEMINI_API_KEY=... node scripts/gen-havana-facade-tiles.mjs [diffuse|emissive|normal]` |
